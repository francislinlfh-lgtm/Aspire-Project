...
% TODO (FL): paragraphs 3-6 per paper/OUTLINE.md scaffold. NOTE the para-2 debt:
...
\begin{figure}[tb]
  ...
  \caption{[Fitted $\alpha(\mathrm{age})$ with bootstrap band; observed decile
  rates overlaid; turning point at 38.0 marked. Figure to be generated from
  the committed execution log.]}
  \label{fig:curve}
\end{figure}
